...
from nonebot import logger, on_command, on_keyword, on_regex
from nonebot.adapters.onebot.v11 import Bot, GroupMessageEvent, Message, MessageSegment
from nonebot.matcher import Matcher
from nonebot.params import _command_arg
from nonebot.typing import T_Handler, T_State

from .depends import check_modify, check_tome
from .download import download_url
from .models import RandomDetailConfig
from .utils import is_file, replace_message
...
def create_matchers():
    def handler(
        ...
        is_specify: bool = False,  # noqa: FBT001
    ) -> T_Handler:
        async def handle(
            matcher: Matcher,
            bot: Bot,
